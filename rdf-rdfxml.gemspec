...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency     'rdf',             '~> 1.1', '>= 1.1.6', '< 1.99'
  gem.add_runtime_dependency     'rdf-rdfa',        '~> 1.1', '>= 1.1.4.1', '< 1.99'
  gem.add_runtime_dependency     'rdf-xsd',         '~> 1.1', '< 1.99'
  ...
  gem.add_development_dependency 'rdf-turtle',      '~> 1.1', '< 1.99'
